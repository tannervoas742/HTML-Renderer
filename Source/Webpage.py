...
class Webpage:
    ...
    def AddJS(self, State = None):
        ...
        with self.Tag('script'):
            ...
            opencollapse += ["            var goto = top + targetElement.getBoundingClientRect().top - 20.5;"]
            ...
            opencollapsewithlinkaddress += ["                var goto = top + targetElement.getBoundingClientRect().top - 20.5;"]
            ...
            opencollapsewithlinkaddress += ["                }"]
            opencollapsewithlinkaddress += ["                if (goto < 0) {"]
            opencollapsewithlinkaddress += ["                    goto = 0;"]
            opencollapsewithlinkaddress += ["                }"]

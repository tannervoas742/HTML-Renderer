...
class WebPage_Commands:
    ...
    def ApplyLateCallbacks(self, Input, State, Interface, Data):

        #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
        if len(State['late_callbacks']) > 0:
            for LateCallback in State['late_callbacks']:
                Data = LateCallback(self, State, Interface, Data)
